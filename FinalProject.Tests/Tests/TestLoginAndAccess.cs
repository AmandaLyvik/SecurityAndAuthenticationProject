...
namespace FinalProject.Tests
{
    ...
    public class TestLoginAndAccess
    {
        ...
        {
            Console.WriteLine("🚨 Running ValidLogin_ShouldAuthenticate...");
            ...
            Console.WriteLine("✅ ValidLogin_ShouldAuthenticate passed.");
        }

        [Test]
        public void InvalidLogin_ShouldFail()
        {
            Console.WriteLine("🚨 Running InvalidLogin_ShouldFail...");
            ...
            Console.WriteLine("✅ InvalidLogin_ShouldFail passed.");
        }

        [Test]
        public void AdminUser_ShouldAccessAdminDashboard()
        {
            Console.WriteLine("🚨 Running AdminUser_ShouldAccessAdminDashboard...");
            ...
            Console.WriteLine("✅ AdminUser_ShouldAccessAdminDashboard passed.");
        }

        [Test]
        public void RegularUser_ShouldBeDeniedAdminAccess()
        {
            Console.WriteLine("🚨 Running RegularUser_ShouldBeDeniedAdminAccess...");
            ...
            Console.WriteLine("✅ RegularUser_ShouldBeDeniedAdminAccess passed.");
        }

        [Test]
        public void UnknownUser_ShouldBeDeniedAdminAccess()
        {
            Console.WriteLine("🚨 Running UnknownUser_ShouldBeDeniedAdminAccess...");
            ...
            Console.WriteLine("✅ UnknownUser_ShouldBeDeniedAdminAccess passed.");
        }

        [Test]
        public void UnauthenticatedUser_ShouldBeDeniedAdminAccess()
        {
            Console.WriteLine("🚨 Running UnauthenticatedUser_ShouldBeDeniedAdminAccess...");
            ...
            Console.WriteLine("✅ UnauthenticatedUser_ShouldBeDeniedAdminAccess passed.");
        }
        ...
        public void Teardown()
        {
            _connection?.Dispose();
            _controller?.Dispose();
            Console.WriteLine("✅ LoginAndAccessTests finished.");
        }
    }
